define([
        'Cesium',
        'text!./shaders/RectangularSensorVS.glsl',
        'text!./shaders/RectangularSensorFS.glsl',
        'text!./shaders/RectangularSensor.glsl',
        'text!./shaders/RectangularSensorScanPlaneFS.glsl'
        ], function(
            Cesium,
            RectangularSensorVS,
            RectangularSensorFS,
